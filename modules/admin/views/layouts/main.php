...
use app\modules\admin\components\menu\MainMenu;
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="<?= Url::home().'admin' ?>" class="logo">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?= Url::to('@web/img/user.png') ?>" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?= Url::to('@web/img/user.png') ?>" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?= $user->fullName ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="<?= Url::to('@web/img/user.png') ?>" class="img-circle" alt="User Image">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?= date('Y') ?> <a href="https://ustadev.uz" target="_blank">
                ustadev.uz
            </a>
        </strong>
        All rights reserved.
